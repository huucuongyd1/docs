...
$ENDPOINT = 'http://hn.storage.weodata.vn';
...
$client = new S3Client([
    ...
    // Set the S3 class to use hn.storage.weodata.vn/bucket
    // instead of bucket.hn.storage.weodata.vn
