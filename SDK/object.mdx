...
sidebarTitle: "Object Ops"
---

## Put Object

To add an object to a bucket, it is necessary to have write permissions on the specified bucket. The user attempting this operation must have the required permissions to write or upload objects to the designated bucket.
...
Retrieves an object from a bucket within Weodata.
...
| if-none-match        | Gets only if object ETag doesn’t match ETag.      | Entity Tag                               | No       |
...
| `409`                       | ObjectNotAppendable      | Specified object cannot be appended          |
